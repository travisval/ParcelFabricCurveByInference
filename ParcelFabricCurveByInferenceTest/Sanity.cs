        ...
        public void NegativeRadiusTest()
        {
            ...
            List<InferredCurve> expectedResults = new List<InferredCurve>() { 
                 ...
                 new InferredCurve(371318, "test", new List<RelatedCurve>() {
                      ...
                      TangentLines = new List<RelatedLine>() {
                           new RelatedLine(371317, 3.09542825410313, CurveByInference.RelativeOrientation.From_To)
                      }},
                 ...
                 new InferredCurve(375549, "test", new List<RelatedCurve>() {
                      ...
                      TangentLines = new List<RelatedLine>() {
                           ...
                           new RelatedLine(375621, -2.65899188901476, CurveByInference.RelativeOrientation.To_To),
                           new RelatedLine(375623, -2.65899188901476, CurveByInference.RelativeOrientation.From_From)
                      }},
                 new InferredCurve(375622, "test", new List<RelatedCurve>() {
                      ...
                      TangentLines = new List<RelatedLine>() {
                           new RelatedLine(375550, 0.482600764575036, CurveByInference.RelativeOrientation.From_From),
                           new RelatedLine(375621, 0.482600764575036, CurveByInference.RelativeOrientation.From_To),
                 ...
                 new InferredCurve(376510, "test", new List<RelatedCurve>() {
                      ...
                      TangentLines = new List<RelatedLine>() {
                           new RelatedLine(376509, 0.378225326986654, CurveByInference.RelativeOrientation.From_To),
                           new RelatedLine(378233, 0.378225326986654, CurveByInference.RelativeOrientation.From_From)
                      }},
                 new InferredCurve(376521, "test", new List<RelatedCurve>() {
                      ...
                      TangentLines = new List<RelatedLine>() {
                           ...
                           new RelatedLine(378220, -0.108065072580877, CurveByInference.RelativeOrientation.To_To)
                      }},
                 ...
                 new InferredCurve(378221, "test", new List<RelatedCurve>() {
                      ...
                      TangentLines = new List<RelatedLine>() {
                           new RelatedLine(376522, 3.03352758100892, CurveByInference.RelativeOrientation.From_From),
                           new RelatedLine(378220, 3.03352758100892, CurveByInference.RelativeOrientation.From_To)
                      }},
                 new InferredCurve(378232, "test", new List<RelatedCurve>() {
                      ...
                      TangentLines = new List<RelatedLine>() {
                           new RelatedLine(376509, -2.76336732660314, CurveByInference.RelativeOrientation.To_To),
